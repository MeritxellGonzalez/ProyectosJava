...
package p4_e7_mgonzalez;

import java.util.Scanner;

/**
 *
 * @author MERITXELL GONZÁLEZ:  PART A I D.
 */
public class P4_E7_MGonzalez {
    ...
    public static final String CASTE = "CASTELLA";
    public static final String CAT = "CATALA";
    public static final String CIENCIA = "CIÈNCIES";
    public static final String PREFE = "INFORMATICA";
    ...
    public static void main(String[] args) {
        ...
        //Variables per realitzar la mitjana
        ...
        PREGUNTEM EL GENERE.
            ...
            if (dadaCorrecta == true) {
                ...
                do {
                    ...
                    System.out.println("Quin és el teu genere:\n\tDona--> " + GENERE_DONA + " \n\tHome--> " + GENERE_HOME + "\n\tNo vull respondre --> " + GENERE_NORESPON + " ");
                    dadaCorrecta = entrada.hasNextInt();
                    if (dadaCorrecta) {
                        ...
                        if (usrArray[1][index] >= GENERE_DONA || usrArray[1][index] <= GENERE_NORESPON) {
                            ...
                            if (usrArray[1][index] == GENERE_DONA) {
                                System.out.println("Has escollit: " + GENERE_DONA + ". És a dir: DONA");
                                dadaCorrecta = true;
                            } else if (usrArray[1][index] == GENERE_HOME) {
                                System.out.println("Has escollit: " + GENERE_HOME + ". És a dir: HOME");
                                dadaCorrecta = true;
                            } else if (usrArray[1][index] == GENERE_NORESPON) {
                                System.out.println("Has escollit: " + GENERE_NORESPON + ". És a dir: NO RESPON");
                                dadaCorrecta = true;
                            } else {
                                dadaCorrecta = false;
            ...
            if (dadaCorrecta) {
                ...
                System.out.println("Dades errònies.");
        ...
        //CÁLCUL MITJANA DE L'EXPERIÈNCIA
        System.out.println("Vols que es mostri la mitjana d'experiència per a cada nivell?\n Sí (1)/ No (0) ");
        dadaCorrecta = entrada.hasNextInt();
